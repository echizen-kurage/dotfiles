...
"    call <SID>X('PmenuSel', 'grey80', 'grey25')
    call <SID>X('Pmenu', 'grey80', 'grey10')    "mod
    call <SID>X('PmenuSel', 'grey80', 'grey25') "mod
    call <SID>X('PmenuSbar', 'grey10', 'grey10')  "mod 
    call <SID>X('PmenuThumb', 'grey80')         "mod
    "Scrollbar
    "Tooltip
